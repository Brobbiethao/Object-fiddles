...
//Have the values to those keys be your favorite thing in that category.
  ...
  //Code here
  var favoriteThings = {band: "DAI",food: "Pho", person: "Kris", book: "Legend of Drizzt", movie: "Logan", holiday: "Labor Day"};
...
//Fill those properties in with the appropriate values.
  ...
  //Code Here
  var alsoMe = {name: "Bob", age: 34, height: "5 foot 3 inches", gender: "male", married: "yes", eyeColor: "brown", hairColor: "black"};
...
//length of each song.
  ...
  //Code Here
  var album = {
    track1: "Nobody", track2: "Great Escape", track3: "Monopolgy game night", track4: "biased media", track5: "Ginger"};
...
//(doesn't have to be accurate).
  ...
  //Code Here
  var states = {California: 100000, Texas: 1, Nevada: 1, Colorado: 1, Arizona: 1};
